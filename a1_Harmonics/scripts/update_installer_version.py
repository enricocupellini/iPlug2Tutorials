...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=a1_Harmonics Demo Installer\n"
      else:
        line="OutputBaseFilename=a1_Harmonics Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the a1_Harmonics Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the a1_Harmonics installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=a1_Harmonics Demo installer\n"
     else:
       line="SetupWindowTitle=a1_Harmonics installer\n"
