...
def main():
  ...
  plistpath = scriptpath + "/resources/a1_Harmonics-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/a1_Harmonics-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/a1_Harmonics-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/a1_Harmonics-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/a1_Harmonics-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/a1_Harmonics.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/a1_Harmonics.iss",inplace=1):
