...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=a2_MidiNoteFilterMod Demo Installer\n"
      else:
        line="OutputBaseFilename=a2_MidiNoteFilterMod Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the a2_MidiNoteFilterMod Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the a2_MidiNoteFilterMod installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=a2_MidiNoteFilterMod Demo installer\n"
     else:
       line="SetupWindowTitle=a2_MidiNoteFilterMod installer\n"
