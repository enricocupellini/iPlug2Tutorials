...
def main():
  ...
  plistpath = scriptpath + "/resources/a2_MidiNoteFilterMod-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/a2_MidiNoteFilterMod-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/a2_MidiNoteFilterMod-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/a2_MidiNoteFilterMod-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/a2_MidiNoteFilterMod-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/a2_MidiNoteFilterMod.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/a2_MidiNoteFilterMod.iss",inplace=1):
