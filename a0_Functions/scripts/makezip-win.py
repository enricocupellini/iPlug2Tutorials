...
def main():
  ...
  if not zip:
    installer = "\\build-win\\installer\\a0_Functions Installer.exe"
    
    if demo:
      installer = "\\build-win\\installer\\a0_Functions Demo Installer.exe"
    
    files = [
      projectpath + installer,
      projectpath + "\\installer\\changelog.txt",
      projectpath + "\\installer\\known-issues.txt",
      projectpath + "\\manual\\a0_Functions manual.pdf" 
    ]
  else:
    files = [
      projectpath + "\\build-win\\a0_Functions.vst3\\Contents\\x86_64-win\\a0_Functions.vst3",
      projectpath + "\\build-win\\a0_Functions_x64.exe"  
    ]
  ...
  files = [
    projectpath + "\\build-win\\pdbs\\a0_Functions-vst3_x64.pdb",
    projectpath + "\\build-win\\pdbs\\a0_Functions-app_x64.pdb"  
  ]
