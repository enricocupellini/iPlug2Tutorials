...
NOTARIZE_BUNDLE_ID=com.EnricoCupellini.a0_Functions
NOTARIZE_BUNDLE_ID_DEMO=com.EnricoCupellini.a0_Functions.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/a0_Functions.iss
#  git checkout installer/a0_Functions.pkgproj
