...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=a0_Functions Demo Installer\n"
      else:
        line="OutputBaseFilename=a0_Functions Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the a0_Functions Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the a0_Functions installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=a0_Functions Demo installer\n"
     else:
       line="SetupWindowTitle=a0_Functions installer\n"
